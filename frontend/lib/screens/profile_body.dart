...
class _ProfileBodyState extends State<ProfileBody> {
  ...
  late String _selectedWardrobeType;
  ...
  void initState() {
    ...
    _selectedWardrobeType = state.wardrobeType;
  }
        ...
        children: [
          ...
          if (_isEditing) ...[
            ...
            _buildInfoCard(
              ...
              label: 'Wardrobe Type',
              value: state.wardrobeType == 'male' ? 'Male' : 'Female',
            ),
          ],
          const SizedBox(height: 24),
          _buildActionButton(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDropdown(
            'Wardrobe Type',
            _selectedWardrobeType,
            ['female', 'male'],
            (v) => setState(() => _selectedWardrobeType = v!),
          ),
