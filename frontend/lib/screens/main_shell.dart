...
class _MainShellState extends State<MainShell> {
  ...
  String? _wardrobeCategory;
  String? _wardrobeSeason;
  int _wardrobeFilterEpoch = 0;
  ...
  void _navigateToWardrobe({String? category, String? season}) {
    setState(() {
      _wardrobeCategory = category;
      _wardrobeSeason = season;
      _wardrobeFilterEpoch++;
      _currentPage = 1;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: DrawerMenu(
        ...
        onAiMatch: () {
          Navigator.pop(context);
          Navigator.pushNamed(context, '/ai-match');
        },
        onProfile: () {
          Navigator.pop(context);
          _navigateTo(3);
      ...
      body: IndexedStack(
        ...
        children: [
          HomeDashboardBody(
            onNavigateToWardrobe: (category, season) {
              _navigateToWardrobe(category: category, season: season);
            },
            onNavigateToPage: (page) => _navigateTo(page),
          ),
          WardrobeBody(
            key: ValueKey(_wardrobeFilterEpoch),
            initialCategory: _wardrobeCategory,
            initialSeason: _wardrobeSeason,
          ),
